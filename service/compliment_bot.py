...
class ComplimentBot:
    ...
    def compliment(self, user_id: str, text: str, response_url: str) -> bool:
        ...
        self.slack_service.send_ephemeral_response(compliment_service.get_confirmation_msg(sender, recipients), response_url)
        
        compliment_message, compliment_blocks = compliment_service.get_compliment(sender, recipients, message)
        for recipient in recipients:
            self.slack_service.send_private_message(recipient["id"], compliment_message, compliment_blocks)
